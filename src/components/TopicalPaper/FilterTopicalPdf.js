...
import TopicalAnswer from './TopicalAnswer';
import TopicalQuestion from './TopicalQuestion';
import TopicalExtra from './TopicalExtra';
const FilterTopicalPdf = ({ singlePaper }) => {
	...
	return (
		<div className="lg:ml-[10px] ml-[70px] lg:mt-0 lg:mr-12 mr-11 mt-2">
			<div className="bg-blue-200 shadow-md rounded pt-2">
				<div className=' flex justify-center item-center lg:gap-5 mb-5'>
					...
					<div
						...
						className=' hover:bg-[#ccc] cursor-pointer  h-full p-2 rounded-lg'>
						<FaKey className={` text-3xl text-blue-800 focus:outline-none ${activeTab === 2
							? " text-red-500"
							: "hover:text-blue-500"
							}`} />
					...
					<div
						...
						className=' hover:bg-[#ccc] cursor-pointer  h-full p-2 rounded-lg'>
						<FaPlus className={` text-3xl text-blue-800 focus:outline-none ${activeTab === 3
							? " text-red-500"
							: "hover:text-blue-500"
							}`} />
			...
			<div className="p-4 ">
				{activeTab === 1 && <TopicalQuestion singlePaper={singlePaper} />}
				{activeTab === 2 && <TopicalAnswer singlePaper={singlePaper} />}
				{activeTab === 3 && <TopicalExtra singlePaper={singlePaper} />}
			</div>
		</div>
	)
}

export default FilterTopicalPdf